    ...
    <div className="App bg-slate-100 w-full h-[100vh]">
      ...
      <div className=' py-1'>
        <div className='my-2 py-4'>
          ...
          <input className='h-10 w-80 rounded-xl shadow-md outline-none pl-3' type='text' value={link} onChange={(e) => linkChange(e)} />
        </div>
        <div className='my-2 py-4'>
        ...
        <button
          className=' bg-slate-600 text-white text-lg rounded-xl w-36 mt-5 py-2 hover:bg-white border-4 border-slite-100 hover:text-slate-600 hover:border-3 hover:border-slate-600 transition duration-600' 
          onClick={generator}>
            Generate
        </button>
